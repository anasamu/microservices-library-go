module github.com/anasamu/microservices-library-go/ai/gateway

go 1.21

require (
	github.com/anasamu/microservices-library-go/ai/providers/anthropic v0.0.0
	github.com/anasamu/microservices-library-go/ai/providers/deepseek v0.0.0
	github.com/anasamu/microservices-library-go/ai/providers/google v0.0.0
	github.com/anasamu/microservices-library-go/ai/providers/openai v0.0.0
	github.com/anasamu/microservices-library-go/ai/providers/xai v0.0.0
