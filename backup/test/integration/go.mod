module github.com/anasamu/microservices-library-go/backup/test/integration
...
require (
	...
	github.com/anasamu/microservices-library-go/backup/providers/local v0.0.0-20250910142242-8bec92b8b0f4
