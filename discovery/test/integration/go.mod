...
require (
	github.com/anasamu/microservices-library-go/discovery v0.0.0-20250912091737-88f10ddf9713
	github.com/anasamu/microservices-library-go/discovery/providers/static v0.0.0-00010101000000-000000000000
